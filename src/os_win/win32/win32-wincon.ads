-- $Source: /home/harp/1/proto/monoBANK/winnt/win32-wincon.ads,v $
-- $Revision: 1.16 $ $Date: 96/09/04 08:14:50 $ $Author: mg $
...
package Win32.WinCon is
    ...
    type union_anonymous1_t
	  ...
	  pragma Convention(C, Union_Anonymous1_T);
...
private
    ...
    pragma Convention(C, COORD);                            -- wincon.h:29
    pragma Convention(C, SMALL_RECT);                       -- wincon.h:34
    pragma Convention(C, KEY_EVENT_RECORD);                 -- wincon.h:41
    pragma Convention(C, MOUSE_EVENT_RECORD);               -- wincon.h:67
    pragma Convention(C, WINDOW_BUFFER_SIZE_RECORD);        -- wincon.h:91
    pragma Convention(C, MENU_EVENT_RECORD);                -- wincon.h:95
    pragma Convention(C, FOCUS_EVENT_RECORD);               -- wincon.h:99
    pragma Convention(C, INPUT_RECORD);                     -- wincon.h:103
    pragma Convention(C, CHAR_INFO);                        -- wincon.h:124
    pragma Convention(C, CONSOLE_SCREEN_BUFFER_INFO);       -- wincon.h:146
    pragma Convention(C, CONSOLE_CURSOR_INFO);              -- wincon.h:154
    ...
    pragma Import(Stdcall, GetConsoleScreenBufferInfo, "GetConsoleScreenBufferInfo");
                                                            -- wincon.h:452
pragma import(stdcall, GetLargestConsoleWindowSize, "GetLargestConsoleWindowSize");
