...
package body Agpl.Containers.Naked_Vectors is
   ...
   function Contains (This : in Object; Item : in Item_Type) return Boolean is
   begin
      for I in This.First .. This.Last loop
         if This.Vector (I) = Item then
            return True;
         end if;
      end loop;
      return False;
...
end Agpl.Containers.Naked_Vectors;
